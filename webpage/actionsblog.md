...
**Last Updated:** 2026-02-23 14:25:41 UTC

**Status:** Maintenance  
**Reason:** The panda cam is currently undergoing scheduled maintenance.  
**Recommendation:** Please check back later around 14:25 UTC for the live feed to be restored.  
**Technical Note:** The image indicates a maintenance message with a timestamp, and the background is grey with red text, signifying an intentional system update or repair.
