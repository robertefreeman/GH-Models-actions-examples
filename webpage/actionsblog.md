...
**Last Updated:** 2026-01-15 20:10:13 UTC

**Status:** Maintenance  
**Reason:** The panda cam is currently undergoing scheduled maintenance, which has temporarily taken the feed offline.  
**Recommendation:** Visitors should check back later; the webcam will be available again after maintenance is completed.  
**Technical Note:** The status image indicates a scheduled downtime with a timestamp for when the feed is expected to be back online (20:10 UTC).  

**Blog Summary:** The panda cam is temporarily offline for scheduled maintenance. Please check back later to see the adorable pandas again!
