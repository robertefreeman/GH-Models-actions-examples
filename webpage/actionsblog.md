...
**Last Updated:** 2026-01-16 22:08:45 UTC

**Status:** Maintenance  
**Reason:** The panda cam is currently undergoing scheduled maintenance, which has temporarily taken the webcam offline.  
**Recommendation:** Visitors should check back later; the webcam feed is expected to be restored after maintenance is completed.  
**Technical Note:** The status image indicates a scheduled downtime with a timestamp of 22:08 UTC for rechecking.
