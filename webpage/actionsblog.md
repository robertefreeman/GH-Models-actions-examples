...
**Last Updated:** 2026-01-05 22:40:52 UTC

**Status:** Maintenance  
**Reason:** The panda cam is currently undergoing scheduled maintenance.  
**Recommendation:** Please check back later around 22:40 UTC for the next update or when the webcam is expected to be available again.  
**Technical Note:** The status image indicates a maintenance message with a grey background and red text, confirming that the live feed is temporarily unavailable for system updates or repairs.
