...
**Last Updated:** 2025-07-29 13:44:09 UTC

**Status:** Maintenance  
**Reason:** The panda cam is currently undergoing scheduled maintenance, which temporarily disables the live feed.  
**Recommendation:** Visitors should check back later; the webcam should be available again after maintenance is completed.  
