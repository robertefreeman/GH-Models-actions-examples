...
**Last Updated:** 2026-01-29 13:30:27 UTC

**Status:** Maintenance  
**Reason:** The panda cam system is currently undergoing scheduled maintenance.  
**Recommendation:** Please check back later around 13:30 UTC for the live feed to be restored.  
**Technical Note:** The status image indicates a maintenance message with a grey background and red text, confirming that the webcam is temporarily offline for updates or repairs.
