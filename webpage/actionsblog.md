...
**Last Updated:** 2026-02-03 18:24:36 UTC

**Status:** Maintenance  
**Reason:** The panda cam system is currently undergoing scheduled maintenance.  
**Recommendation:** Please check back later for live footage of the pandas. Expect the webcam to be unavailable until maintenance is complete.  
**Technical Note:** The status image indicates a maintenance message in red text on a gray background, with a timestamp of 18:24 UTC for the next check.
