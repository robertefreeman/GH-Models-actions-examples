...
**Last Updated:** 2026-01-28 22:10:59 UTC

**Status:** Maintenance  
**Reason:** The panda cam is currently undergoing scheduled maintenance to ensure optimal operation.  
**Recommendation:** Please check back later around 22:10 UTC for the live feed to be restored.  
**Technical Note:** The status image indicates a maintenance message with a timestamp for when the camera is expected to be available again.

**Blog Summary:** The panda cam is temporarily offline for scheduled maintenance. We appreciate your patience and look forward to bringing the adorable pandas back on view soon!
