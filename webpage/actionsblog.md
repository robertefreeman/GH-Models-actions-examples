...
**Last Updated:** 2026-01-01 22:08:19 UTC

**Status:** Maintenance  
**Reason:** The panda cam is currently undergoing scheduled maintenance.  
**Recommendation:** Please check back later around 22:08 UTC for the next update. Expect the live feed to be temporarily unavailable during this period.  
**Technical Note:** The status image indicates a maintenance message with a timestamp for when the feed is expected to be operational again.
