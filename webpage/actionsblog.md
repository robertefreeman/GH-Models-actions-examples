...
**Last Updated:** 2026-02-09 21:48:22 UTC

**Status:** Maintenance  
**Reason:** The panda cam is currently undergoing scheduled maintenance.  
**Recommendation:** Please check back later for the live feed; the camera should be available again after maintenance is completed.  
**Technical Note:** The image indicates a maintenance message with a timestamp of 21:48 UTC, and the background is grey with red text, signifying an intentional system update or repair.
